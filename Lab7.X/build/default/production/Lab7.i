...
unsigned char tempSensor = 0;

unsigned char newAddress = 0x00;
unsigned char passwordAddress[] = {0x01, 0x02, 0x03, 0x04};
unsigned char pirAddress = 0x05;
unsigned char inputAddress = 0x06;
unsigned char tempAddress = 0x07;
...
unsigned char enterNew = EEPROM_ReadByte(newAddress);
...
EEPROM_ReadString(passwordAddress, password, 4);
...
double temp1 = (fullAD*(5.0)/((1 << 10) - 1));
int temp = (int)(temp1*180 - 58);
