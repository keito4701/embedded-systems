...
int get_Voltage(int ac0, int ac1, char* temp1,int minv, int maxv);
...
int a = get_Voltage(0b00111001, 0b11000000, Str_1, 0, 50);
TRISEbits.TRISE2 = 0;
char whole = (char)(a/10);
char deci = (char)(a%10);
...
int f = get_Voltage(0b00100001, 0b11000000, Str_2, 2, 100);
char hundo = (char)(f/100);
whole = (char)(f%100/10);
deci = (char)(f%10);
...
float temp = a1*sin(2*3.14159265358979323846*f*i);
temp += 5;
temp /= 10;
temp *= 255;
dataByte = (char)(temp);
...
# 130
_delay((unsigned long)((125)*(10000000/4000.0)));
...
int v = (int)(fullAD*(maxv - minv)/((1 << 10) - 1) + minv);
