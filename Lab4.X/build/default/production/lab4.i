...
int get_Voltage(int ac0, int ac1, char* temp1, int maxv);
...
while(1) {
TRISEbits.TRISE2 = 1;
int v1 = get_Voltage(0b00111001, 0b11000000, Str_1, 50);
TRISEbits.TRISE2 = 0;

int v2 = get_Voltage(0b00100001, 0b11000000, Str_2, 50);
...
int v = (int)(fullAD*(maxv)/((1 << 10) - 1));
char whole = (char)(v/10);
char deci = (char)(v%10);
